...
class MAT_FREE_POGS(SCS):
    ...
    def get_problem_data(self, objective, constraints, cached_data):
        ...
        data['constr_root'] = constr_root
        data['var_sizes'] = sym_data.var_sizes
        cones = self.convert_dims_to_indices(sym_data.dims)
    ...
    def solve(self, objective, constraints, cached_data, verbose, solver_opts):
        ...
        (data, cones), obj_offset = self.get_problem_data(objective,
                                                         constraints,
                                                         cached_data)
        results_dict = canonInterface.pogs_solve(data['c'], data['b'],
                                                 data['constr_root'],
                                                 data['var_sizes'],
                                                 cones)
